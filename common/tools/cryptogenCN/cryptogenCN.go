...
import (
	...
	"github.com/hyperledger/fabric/common/tools/cryptogenCN/metadata"
	"github.com/hyperledger/fabric/common/tools/cryptogenCN/msp"
)
...
//command line flags
var (
	app = kingpin.New("cryptogenCN", "Utility for generating Hyperledger Fabric key material")
...
func getConfig(configFile **os.File) (*Config, error) {
...
func Generate(configFile **os.File, outputDir *string) {
...
func generatePeerOrg(baseDir string, orgSpec OrgSpec) {
	...
	// generate TLS CA
	tlsCA, err := ca.NewTlsCA(tlsCADir, orgName, "tls"+orgSpec.CA.CommonName)
	if err != nil {
...
func generateNodes(baseDir string, nodes []NodeSpec, signCA *ca.CA, tlsCA *ca.TlsCA) {
